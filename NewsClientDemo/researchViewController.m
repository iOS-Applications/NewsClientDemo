...
#import "NewsFrame.h"
#import "NewsModel.h"
@interface researchViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"researchModel.plist" ofType:nil]];
    ...
    __weak typeof(researchViewController) *weakSelf = self;
    
    //下拉想做什么？在这里设置吧
    self.refreshBlock = ^{
        
        __strong typeof(researchViewController) *strongSelf = weakSelf;
