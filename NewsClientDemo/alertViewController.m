...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"alertModel.plist" ofType:nil]];
    ...
    __weak typeof(alertViewController) *weakSelf = self;
    
    //下拉想做什么？在这里设置吧
    self.refreshBlock = ^{
        
        __strong typeof(alertViewController) *strongSelf = weakSelf;
