...
@interface lastestViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"lastestModel.plist" ofType:nil]];
...
//        NSLog(@"%@",dict);
        ...
        __weak typeof(lastestViewController) *weakSelf = self;
    
        //下拉想做什么？在这里设置吧
        self.refreshBlock = ^{
    
            __strong typeof(lastestViewController) *strongSelf = weakSelf;
...
/*!
 *  @author Pasco, 15-09-21 11:09:55
 *
 *  @brief  配置tableView
 *
 *  @since 1.0
