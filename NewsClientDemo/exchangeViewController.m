...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"exchangeModel.plist" ofType:nil]];
    ...
    __weak typeof(exchangeViewController) *weakSelf = self;
    
    //下拉想做什么？在这里设置吧
    self.refreshBlock = ^{
        
        __strong typeof(exchangeViewController) *strongSelf = weakSelf;
...
//    self.sc_navigationItem.leftBarButtonItem = self.leftBarItem;
    self.sc_navigationItem.title = @"学术交流";
