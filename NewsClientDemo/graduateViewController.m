...
#import "NewsFrame.h"
#import "NewsModel.h"
@interface graduateViewController ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"graduateModel.plist" ofType:nil]];
    ...
    __weak typeof(graduateViewController) *weakSelf = self;
    
    //下拉想做什么？在这里设置吧
    self.refreshBlock = ^{
        
        __strong typeof(graduateViewController) *strongSelf = weakSelf;
...
//    self.sc_navigationItem.leftBarButtonItem = self.leftBarItem;
    self.sc_navigationItem.title = @"研究生教学";
