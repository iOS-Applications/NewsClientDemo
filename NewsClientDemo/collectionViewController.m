...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"newsModel.plist" ofType:nil]];
    ...
    __weak typeof(collectionViewController) *weakSelf = self;
    
    //下拉想做什么？在这里设置吧
    self.refreshBlock = ^{
        
        __strong typeof(collectionViewController) *strongSelf = weakSelf;
